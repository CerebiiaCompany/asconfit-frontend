    ...
    return (
        <div className="relative">
            <button
                ...
                className="p-2 rounded-full bg-white bg-opacity-20 hover:bg-opacity-30 transition duration-150 relative"
            >
                <svg
                        ...
                        <div className="overflow-y-auto flex-1">
                            {notifications.length === 0 ? (
                                ...
                                notifications.map((notification) => (
                                    <div
                                        key={notification.id}
                                        className={`px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition duration-150 cursor-pointer ${!notification.read ? 'bg-blue-50' : ''
                                            }`}
                                        onClick={() => {
