    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
      <div>
        <div className="text-sm font-bold text-gray-800 mb-2 flex items-center gap-1">
          Empresas <span className="text-gray-400 mx-1 font-normal">&gt;</span> <span className="text-gray-600">{isEdit ? "Actualizar empresa" : "Crear empresa"}</span>
        </div>
        <button 
          onClick={() => navigate(-1)}
          type="button"
      ...
      <div className="flex items-center gap-4">
        {!isEdit && (
          <button type="button" className="flex items-center gap-2 px-6 py-2 bg-orange-500 text-white rounded font-semibold hover:bg-orange-600 transition-colors shadow-sm text-sm">
