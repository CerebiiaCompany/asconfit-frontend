    ...
    return (
        <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="text-sm text-gray-600 sm:w-44 flex-shrink-0">Dirección:</label>
                    <input
                        type="text"
                        name="direccion"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="text-sm text-gray-600 sm:w-44 flex-shrink-0">Razón social:</label>
                    <input
                        type="text"
                        name="razonSocial"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="text-sm text-gray-600 sm:w-44 flex-shrink-0">Responsable o representante legal:</label>
                    <input
                        type="text"
                        name="responsable"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="text-sm text-gray-600 sm:w-44 flex-shrink-0">Actividad Económica CIU:</label>
                    <input
                        type="text"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="text-sm text-gray-600 sm:w-44 flex-shrink-0">Contacto:</label>
                    <input
                        type="text"
                        name="contacto"
