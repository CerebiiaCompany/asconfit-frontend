...
export const SubtareaItem: React.FC<SubtareaItemProps> = ({ subtarea, onRemove, onChange }) => {
    return (
        <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    <label className="block text-sm text-gray-600 mb-2">Fecha de solicitud</label>
                    <input
                        type="date"
                ...
                <div>
                    <label className="block text-sm text-gray-600 mb-2">Tiempo entrega</label>
                    <input
                        type="text"
            ...
            <div className="mb-4">
                <label className="block text-sm text-gray-600 mb-2">Estado de información</label>
                <select
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4 items-start sm:items-end">
                <div className="flex-1">
                    <label className="block text-sm text-gray-600 mb-2">Formato de archivo</label>
                    <select
