  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto font-sans min-h-screen bg-white">
      ...
      <div className="max-w-[700px] mx-auto">
        <h2 className="text-[26px] font-bold text-gray-700 text-center mb-10">
          Datos Generales
        </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              <select className="w-full px-4 py-2 border border-gray-300 rounded text-sm text-gray-400 appearance-none focus:outline-none focus:ring-1 focus:ring-orange-500 bg-white cursor-pointer">
                ...
                <option value="sas" className="text-gray-800">
                  S.A.S
                </option>
                <option value="ltda" className="text-gray-800">
                  LTDA
                </option>
                <option value="sa" className="text-gray-800">
                  S.A
                </option>
              </select>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              <select className="w-full px-4 py-2 border border-gray-300 rounded text-sm text-gray-400 appearance-none focus:outline-none focus:ring-1 focus:ring-orange-500 bg-white cursor-pointer">
                ...
                <option value="activa" className="text-gray-800">
                  Activa
                </option>
                <option value="inactiva" className="text-gray-800">
                  Inactiva
                </option>
              </select>
              <ChevronDown className="absolute right-3 top-[34px] w-4 h-4 text-orange-400 pointer-events-none" />
