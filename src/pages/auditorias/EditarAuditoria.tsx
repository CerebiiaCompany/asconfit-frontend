...
export const EditarAuditoria: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    // En edición solo validamos que cada categoría tenga nombre, delegado
    // y que cada subtarea tenga nombre. No validamos campos de empresa/fechas
    // porque ya existen y no se editan en esta pantalla.
    const newErrors: any = {};
